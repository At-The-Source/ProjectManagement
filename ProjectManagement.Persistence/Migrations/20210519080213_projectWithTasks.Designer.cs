...
namespace ProjectManagement.Persistence.Migrations
{
    ...
    [Migration("20210519080213_projectWithTasks")]
    partial class projectWithTasks
    {
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = new Guid("44affb1e-06a8-4524-a2ce-544c81524382"),
                            StartDate = new DateTime(2021, 5, 27, 10, 2, 11, 676, DateTimeKind.Local).AddTicks(1964),
                            StopDate = new DateTime(2021, 5, 29, 10, 2, 11, 684, DateTimeKind.Local).AddTicks(2589),
                        ...
                        new
                        {
                            ...
                            ProjectId = new Guid("44affb1e-06a8-4524-a2ce-544c81524382"),
                            StartDate = new DateTime(2021, 5, 23, 10, 2, 11, 684, DateTimeKind.Local).AddTicks(5827),
                            StopDate = new DateTime(2021, 5, 31, 10, 2, 11, 684, DateTimeKind.Local).AddTicks(5858),
