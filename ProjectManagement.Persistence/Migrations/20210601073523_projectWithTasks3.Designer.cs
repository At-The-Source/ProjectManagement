...
namespace ProjectManagement.Persistence.Migrations
{
    ...
    [Migration("20210601073523_projectWithTasks3")]
    partial class projectWithTasks3
    {
            ...
            modelBuilder.Entity("ProjectManagement.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = new Guid("44affb1e-06a8-4524-a2ce-544c81524382"),
                            StartDate = new DateTime(2021, 6, 9, 9, 35, 21, 993, DateTimeKind.Local).AddTicks(3945),
                            StopDate = new DateTime(2021, 6, 11, 9, 35, 21, 999, DateTimeKind.Local).AddTicks(5932),
                        ...
                        new
                        {
                            ...
                            ProjectId = new Guid("44affb1e-06a8-4524-a2ce-544c81524382"),
                            StartDate = new DateTime(2021, 6, 5, 9, 35, 21, 999, DateTimeKind.Local).AddTicks(9228),
                            StopDate = new DateTime(2021, 6, 13, 9, 35, 21, 999, DateTimeKind.Local).AddTicks(9270),
